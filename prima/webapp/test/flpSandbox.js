		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App",
									"targetURL": "#opensapprima-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"opensapprima-display": {
								"semanticObject": "opensapprima",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=opensap.prima",
									"url": sap.ui.require.toUrl("opensap/prima")
								}
							}
						}
					}
